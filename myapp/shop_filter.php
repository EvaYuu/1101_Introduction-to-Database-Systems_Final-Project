<?php
    ...
    if($fdis == 'near'){
        ...
        $conditions[] = 'distance between ? and ?';
        $parameters[] = $a;
        $parameters[] = $b;
    }
    else if($fdis == 'far'){
    ...
    // the main query
    $sql = "select shop_name, shop_category, ST_Distance_Sphere(POINT($ulon,$ulat), location) as distance from shops natural join menus";
